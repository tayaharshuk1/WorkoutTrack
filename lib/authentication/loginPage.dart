...
import 'package:workout_tracker/setWorkouts.dart';
            ...
            Container(
              ...
              child: Column(
                ...
                children:  [
                  ...
                  SizedBox(height: 5,),
                  const Text('Workout Track', style: TextStyle(fontSize: 20,color: Colors.white,fontWeight: FontWeight.bold ),),
                  SizedBox(height: 50,),
                  Column(
                    crossAxisAlignment: CrossAxisAlignment.center,
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  GestureDetector(
                                      ...
                                      child: Text(" Register Now", style: TextStyle(color:Colors.redAccent, fontWeight: FontWeight.bold),))
                                ],
                              ),
