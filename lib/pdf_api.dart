...
class PdfApi{
  ...
  static Future<void> createPDF(String name,String birthday,String IDnumber,Uint8List bytes1,
    ...
    pdf.addPage(MultiPage(
        build: (context) => <Widget>[
          ...
          Row( children: [
            ...
            Header(child: Text(name + "'s Workout Review", style: TextStyle(fontSize: 30, color: PdfColors.blue,))),
          ],),
          ...
          Bullet(text: "Full name: " + name, bulletColor: PdfColors.blue,style: TextStyle( fontSize: 15)),
          ...
          SizedBox(height: 20),
          Text('Workout statistics:', style: TextStyle(fontSize: 15, color: PdfColors.blue800,decoration: TextDecoration.underline)),
    ...
    //pdf.dispose();
    saveAndLaunchFile(bytes, 'WorkoutReview.pdf');
  }
